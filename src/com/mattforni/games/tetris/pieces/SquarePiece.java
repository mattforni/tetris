 ...
 * SquarePiece.java
 * 
 * this class models the square piece from tetris.  it places two squares
 * along a row, then drops a row and places two more,
 * creating a square of four smartsquares. 
 * 
...
public class SquarePiece extends Piece implements Constants {

	public SquarePiece(Grid grid, Point p) {
		super(grid);
